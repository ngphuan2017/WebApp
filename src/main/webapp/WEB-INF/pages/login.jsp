...
<div class="main">
    <div class="content">
        <div class="wrapper">
            <form method="post" action="${login}" id="form-login">
                ...
                <div id="error-message"
                     style="font-size: 13px; color: red; display: block; text-align: center;">${error}</div>
                <div style="width: 100%; padding: 5px 0;">
                    ...
                    <div style="width: 40%; display: inline-block; text-align: right;">
                        <a href="javascript:;" onclick="forgotPassword()" style="color: #09f; font-size: 12px;">Quên mật
                            khẩu?</a>
                    </div>
                </div>
                <p class="inner">
                ...
                <div class="google-btn">
                    <a href="https://accounts.google.com/o/oauth2/auth?scope=profile+email&redirect_uri=https://phuanshop.id.vn/login/login-google&response_type=code&client_id=954599608854-46336kvovn5g8ggmsp11dslgh6chn71c.apps.googleusercontent.com&approval_prompt=force">
        ...
        <div class="banner">
            <div class="clouds">
                <img src="<c:url value="https://res.cloudinary.com/dkmug1913/image/upload/v1687075887/WebApp/cloud1_ortplp.png" />"
                     style="--i:1;">
                <img src="<c:url value="https://res.cloudinary.com/dkmug1913/image/upload/v1687075891/WebApp/cloud2_ngpdc4.png" />"
                     style="--i:2;">
                <img src="<c:url value="https://res.cloudinary.com/dkmug1913/image/upload/v1687075895/WebApp/cloud3_szlrii.png" />"
                     style="--i:3;">
            </div>
        </div>
    </div>
